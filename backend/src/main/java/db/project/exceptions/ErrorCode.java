...
public enum ErrorCode {
    ...
    USERNAME_NOT_FOUND(401, "NOT EXIST USERNAME"),
    ...
    NON_EXIST_LOCATION(404, "NON EXIST LOCATION ID"),
    NON_EXIST_BIKE(404, "NON EXIST BIKE ID"),
    FAVORITE_DUPLICATION(409, "ALREADY ADD FAVORITE"),
    TICKET_DUPLICATION(409, "ALREADY HAVE TICKET"),
    BIKE_DUPLICATION(409, "BIKE ID DUPLICATE"),
    LOCATION_DUPLICATION(409, "LOCATION ID DUPLICATE"),
